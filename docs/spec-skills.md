...
`lpagent` must support skills as reusable instruction bundles that can be discovered from disk, referenced by users, and injected into turns in a structured way.

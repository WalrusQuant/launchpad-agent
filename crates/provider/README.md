...
In short, higher layers construct a `lpa_protocol::ModelRequest`, send it
through a `ModelProviderSDK`, and receive either a complete
`lpa_protocol::ModelResponse` or a stream of `lpa_protocol::StreamEvent`
values.
...
- `lpa_provider::ModelProviderSDK`
- `lpa_provider::ProviderAdapter`
- `lpa_provider::ProviderCapabilities`

It also exposes the provider family modules:

- `lpa_provider::openai`
- `lpa_provider::anthropic`

...
use lpa_core::{ProviderWireApi, provider_id_for_endpoint, provider_name_for_endpoint};
...
fn merge_onboarding_config(
    ...
    profile_table.insert(
        ...
        Value::String(match provider {
            ...
            ProviderFamily::Google { .. } => "google_generate_content".to_string(),
        }),
    );

...
use lpa_protocol::{SkillChangedParams, SkillListParams, SkillListResult};
use lpa_server::{
    ...
    let result = SkillListResult {
        skills: vec![
            ...
            lpa_protocol::SkillRecord {
                ...
                enabled: false,
                source: lpa_protocol::SkillSource::Workspace {
...
fn session_title_updated_event_serializes_expected_kind() {
    let event = ServerEvent::SessionTitleUpdated(lpa_server::SessionEventPayload {

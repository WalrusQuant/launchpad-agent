...
async fn runtime_rebuilds_sessions_from_rollout_and_resume_works() -> Result<()> {
    ...
    let session_id = serde_json::from_value::<
        lpa_server::SuccessResponse<lpa_server::SessionStartResult>,
    >(start_response)?
    .result
    .session_id;
    ...
    let list_result = serde_json::from_value::<
        lpa_server::SuccessResponse<lpa_server::SessionListResult>,
    >(list_response)?
    .result;
    ...
    let resume_result = serde_json::from_value::<
        lpa_server::SuccessResponse<lpa_server::SessionResumeResult>,
    >(resume_response)?
    .result;
...
async fn runtime_generates_final_title_and_persists_explicit_rename() -> Result<()> {
    ...
    assert_eq!(
        ...
        lpa_core::SessionTitleState::Final(lpa_core::SessionTitleFinalSource::ModelGenerated)
    );
    ...
    let rename_result = serde_json::from_value::<
        lpa_server::SuccessResponse<lpa_server::SessionTitleUpdateResult>,
    >(rename_response)?
    .result;
    assert_eq!(
    ...
    assert_eq!(
        ...
        lpa_core::SessionTitleState::Final(lpa_core::SessionTitleFinalSource::UserRename)
    );
...
async fn runtime_assigns_provisional_title_after_first_prompt() -> Result<()> {
    ...
    assert_eq!(
        ...
        lpa_core::SessionTitleState::Provisional
    );
    Ok(())
}
...
async fn initialize_connection(
    ...
    let response: lpa_server::SuccessResponse<lpa_server::InitializeResult> =

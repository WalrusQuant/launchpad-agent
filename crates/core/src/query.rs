...
use crate::{
    AgentError, CompactionOutcome, ContentBlock, EligibilitySelector, Message, Model, Role,
...
pub async fn test_model_connection(
    ...
    let request = ModelRequest {
        model: request_model,
        system: None,
        messages: vec![lpa_protocol::RequestMessage {
            role: "user".to_string(),
            content: vec![lpa_protocol::RequestContent::Text {

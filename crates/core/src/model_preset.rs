...
//! - convert raw presets into runtime `lpa_protocol::Model` values
//!
//! Design:
...
pub struct ModelPreset {
    ...
    #[serde(
        ...
        deserialize_with = "lpa_protocol::deserialize_provider"
    )]
    ...
    #[serde(
        default,
        deserialize_with = "lpa_protocol::deserialize_truncation_policy_config"
    )]

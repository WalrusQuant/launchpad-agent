...
```bash
cargo build --release
cargo test --workspace      # 467 tests currently passing
...
Rust 1.85+. All 467 tests currently pass — keep it that way.

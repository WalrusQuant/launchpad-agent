...
This repository is a Rust-based coding agent called `launchpad-agent`.
- All crate names use the `lpa-` prefix. For instance, the crate in the `core` directory is named `lpa-core`.
